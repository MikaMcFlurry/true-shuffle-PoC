...
| 24 | Adversarialer Review der §A-Abschlussrunde (6 Linsen: Zitate, Rot-vor-Fix, Statusverteidigung, ADR-004-Kohärenz, Suitenzahlen, Ehrlichkeit) | **Opus** (kein Implementierungskontext) | dispatched | Lead entscheidet über Funde |
| 25 | Unabhängiger Security-/Privacy-Review (OAuth/PKCE, TokenVault, CSRF, IDOR, F10-Löschpfad, Logs) | **Opus** (kein Implementierungskontext) | dispatched | Lead entscheidet über Funde |
